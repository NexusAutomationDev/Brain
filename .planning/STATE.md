...
| 260718-x2p | Bump compose do brain-sdr de v1.6.1→v1.6.2 (tag inédita força CI/CD a rebuildar imagem limpa; v1.6.1 no host estava stale, PRECONDITION_FAILED persistia) | 2026-07-18 | b105f9f | [260718-x2p-bump-brain-sdr-compose-para-v1-6-2](./quick/260718-x2p-bump-brain-sdr-compose-para-v1-6-2/) |

Last activity: 2026-07-18 - Completed quick task 260718-x2p: compose do brain-sdr apontado para v1.6.2 (tag inédita para forçar rebuild/redeploy do fix passive-declare)
